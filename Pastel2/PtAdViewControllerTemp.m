...
@interface PtAdViewControllerTemp ()

@end

@implementation PtAdViewControllerTemp
...
- (void)viewDidLoad
{
    ...
    self.navigationBar.title = NSLocalizedString(@"Warmth", nil);
...
- (void)applyCurrentFiltersToOriginalImage
{
    ...
    queue.adjustmentType = PtAdProcessQueueAdjustmentTypeTemp;
