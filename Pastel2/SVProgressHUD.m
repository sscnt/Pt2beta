...
+ (void)show {
    [[SVProgressHUD sharedView] showProgress:-1 status:nil maskType:SVProgressHUDMaskTypeNone interval:0 addTarget:nil selector:nil];
}

+ (void)showWithStatus:(NSString *)status {
    [[SVProgressHUD sharedView] showProgress:-1 status:status maskType:SVProgressHUDMaskTypeNone interval:0 addTarget:nil selector:nil];
}

+ (void)showWithMaskType:(SVProgressHUDMaskType)maskType {
    [[SVProgressHUD sharedView] showProgress:-1 status:nil maskType:maskType interval:0 addTarget:nil selector:nil];
}

+ (void)showWithStatus:(NSString*)status maskType:(SVProgressHUDMaskType)maskType {
    [[SVProgressHUD sharedView] showProgress:-1 status:status maskType:maskType interval:0 addTarget:nil selector:nil];
}


+ (void)showWithStatus:(NSString*)status maskType:(SVProgressHUDMaskType)maskType interval:(NSTimeInterval)interval addTarget:(id)target selector:(SEL)selector
{
    [[SVProgressHUD sharedView] showProgress:-1 status:status maskType:maskType interval:interval addTarget:target selector:selector];
}



+ (void)showProgress:(CGFloat)progress {
    [[SVProgressHUD sharedView] showProgress:progress status:nil maskType:SVProgressHUDMaskTypeNone interval:0 addTarget:nil selector:nil];
}

+ (void)showProgress:(CGFloat)progress status:(NSString *)status {
    [[SVProgressHUD sharedView] showProgress:progress status:status maskType:SVProgressHUDMaskTypeNone interval:0 addTarget:nil selector:nil];
}

+ (void)showProgress:(CGFloat)progress status:(NSString *)status maskType:(SVProgressHUDMaskType)maskType {
    [[SVProgressHUD sharedView] showProgress:progress status:status maskType:maskType interval:0 addTarget:nil selector:nil];
}
...
- (void)positionHUD:(NSNotification*)notification {
    ...
    CGFloat posY = floor(activeHeight*0.45) + 44.0;
