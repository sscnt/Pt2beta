...
- (void)makeFilterGroup
{
    ...
    [levelsFilter3 setMin:10.0f/255.0f gamma:0.90f max:220.0f/255.0f minOut:0.0f maxOut:255.0f/255.0f];
    ...
    brightnessFilter.brightness = 0.15f;
    ...
    [photoFilter1 addTarget:brightnessFilter];
