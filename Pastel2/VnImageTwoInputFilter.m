...
#import "VnImageTwoInputFilter.h"

NSString *const kVnImageTwoInputTextureVertexShaderString = SHADER_STRING
(
...
@implementation VnImageTwoInputFilter
...
- (id)initWithFragmentShaderFromString:(NSString *)fragmentShaderString;
{
    ...
    if (!(self = [self initWithVertexShaderFromString:kVnImageTwoInputTextureVertexShaderString fragmentShaderFromString:shader]))
    {
		return nil;
    }
